...
fun InternetErrorScreen(
    ...
    ErrorScreen(
        modifier = modifier,
        title = stringResource(R.string.text_template_error_internet),
        description = stringResource(R.string.text_template_error_internet_desc),
...
@Preview
@Composable
private fun InternetErrorScreenPreview() {
    AppTheme {
        InternetErrorScreen(
            onTryAgainClick = { },
        )
